...
import org.crossbridge.jst.server.report.core.internal.xml.server32.*;
...
public class Tomcat32Configuration extends TomcatConfiguration {
	 ...
	 */
	public IStatus localizeConfiguration(IPath baseDir, IPath deployDir, TomcatServerReport server2, IProgressMonitor monitor) {
		try {
			monitor = ProgressUtil.getMonitorFor(monitor);
