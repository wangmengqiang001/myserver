 ...
 * Tomcat 80 handler.
 */
public class Tomcat80Handler implements ITomcatVersionHandler {
	/**
	...
	/**
	 * @see ITomcatVersionHandler#getRuntimeBaseDirectory(TomcatServerReport)
	 */
	public IPath getRuntimeBaseDirectory(TomcatServerReport server) {
	...
	/**
	 * @see ITomcatVersionHandler#prepareForServingDirectly(IPath, TomcatServerReport)
	 */
	public IStatus prepareForServingDirectly(IPath baseDir, TomcatServerReport server, String tomcatVersion) {
