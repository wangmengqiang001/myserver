 ...
 **********************************************************************/
package org.crossbridge.jst.server.report.core.internal;
...
import org.crossbridge.jst.server.report.core.internal.xml.Factory;
import org.crossbridge.jst.server.report.core.internal.xml.XMLUtil;
import org.crossbridge.jst.server.report.core.internal.xml.server40.Connector;
import org.crossbridge.jst.server.report.core.internal.xml.server40.Context;
import org.crossbridge.jst.server.report.core.internal.xml.server40.Listener;
import org.crossbridge.jst.server.report.core.internal.xml.server40.Server;
import org.crossbridge.jst.server.report.core.internal.xml.server40.ServerInstance;
import org.crossbridge.jst.server.report.core.internal.xml.server40.Service;
...
public class Tomcat85Configuration extends TomcatConfiguration {
	private static final String PLUGIN_BASEPACKAGE = "org.crossbridge.jst.server.report.core.internal";
	...
	public void load(IPath path, IProgressMonitor monitor) throws CoreException {
		try {
			...
			serverFactory.setPackageName(PLUGIN_BASEPACKAGE+".xml.server40");
	...
	/**
	 * @see TomcatConfiguration#localizeConfiguration(IPath, IPath, TomcatServerReport, IProgressMonitor)
	 */
	public IStatus localizeConfiguration(IPath baseDir, IPath deployDir, TomcatServerReport tomcatServer, IProgressMonitor monitor) {
