...
public class TomcatServerBehaviour extends ServerBehaviourDelegate implements ITomcatServerBehaviour, IModulePublishHelper {
	...
	public TomcatServerReport getTomcatServer() {
		return (TomcatServerReport) getServer().loadAdapter(TomcatServerReport.class, null);
	}
	...
	protected void publishFinish(IProgressMonitor monitor) throws CoreException {
		...
		TomcatServerReport ts = getTomcatServer();
